...
export default {
  ...
  props: {
    ...
    explain: {
      ...
      default: "Drag slider right to fill puzzle",
    },
    imgSize: {
      type: Object,
      default() {
  ...
  methods: {
    ...
    start: function (e) {
      ...
      if (this.isEnd === false) {
        ...
        this.leftBarBorderColor = "#E9F2FA";
        this.iconColor = "#fff";
        e.stopPropagation();
        this.status = true;
      }
      ...
      if (this.status && this.isEnd === false) {
        ...
        if (
          ...
          this.barArea.offsetWidth -
            parseInt(Math.floor((parseInt(this.setSize.imgWidth) * 47) / 310))
        ) {
          move_block_left =
            this.barArea.offsetWidth -
            parseInt(
              Math.floor((parseInt(this.setSize.imgWidth) * 47) / 310) - 4
            );
        }
