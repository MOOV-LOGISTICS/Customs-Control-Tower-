...
function buildFormTemplate(scheme, child, type) {
  ...
  let str = `<el-form :show-message="false"	 	 size='mini' ref="${scheme.formRef}" :model="${scheme.formModel}" :rules="${scheme.formRules}" size="${scheme.size}" ${disabled} label-width="${scheme.labelWidth}px" ${labelPosition}>
      ${child}
...
function buildElUploadChild(scheme) {
  ...
  else list.push(`<el-button size="mini"   type="primary" icon="el-icon-upload">${config.buttonText}</el-button>`)
