<template>
  <div class="panel-tab__content">
    ...
    <el-drawer :visible.sync="listenerFormModelVisible" title="执行监听器" :size="`${width}px`" append-to-body destroy-on-close>
      <el-form :show-message="false"	 	 size='mini'  :model="listenerForm" label-width="96px" ref="listenerFormRef" @submit.native.prevent>
      ...
      <div class="element-drawer__button">
        <el-button size="mini"   @click="listenerFormModelVisible = false">{{$t('el.popconfirm.cancelButtonText')}}</el-button>
    ...
    <el-dialog title="字段配置" :visible.sync="listenerFieldFormModelVisible" width="600px" append-to-body destroy-on-close>
      <el-form :show-message="false"	 	 size='mini' :model="listenerFieldForm"  label-width="96px" ref="listenerFieldFormRef" style="height: 136px" @submit.native.prevent>
      ...
      <template slot="footer">
        <el-button size="mini"   @click="listenerFieldFormModelVisible = false">{{$t('el.popconfirm.cancelButtonText')}}</el-button>
        <el-button size="mini"   type="primary" @click="saveListenerFiled">{{$t('el.popconfirm.confirmButtonText')}}</el-button>
      </template>
    </el-dialog>
  </div>
</template>
