<template>
  <div class="panel-tab__content">
    ...
    <el-dialog :visible.sync="propertyFormModelVisible" title="属性配置" width="600px" append-to-body destroy-on-close>
      <el-form :show-message="false"	 	 size='mini' :model="propertyForm" label-width="120px"  ref="attributeFormRef" @submit.native.prevent>
      ...
      <template slot="footer">
        <el-button size="mini"   @click="propertyFormModelVisible = false">{{$t('el.popconfirm.cancelButtonText')}}</el-button>
        <el-button size="mini"   type="primary" @click="saveAttribute">{{$t('el.popconfirm.confirmButtonText')}}</el-button>
      </template>
    </el-dialog>
  </div>
</template>
