<template>
  <div class="panel-tab__content">
    <el-form :show-message="false"	 	 size='mini'  label-width="120px" @submit.native.prevent>
    ...
    <el-drawer :visible.sync="fieldModelVisible" title="字段配置" :size="`${width}px`" append-to-body destroy-on-close>
      <el-form :show-message="false"	 	 size='mini' :model="formFieldForm" label-width="90px"  @submit.native.prevent>
      ...
      <!-- 底部按钮 -->
      <div class="element-drawer__button">
        <el-button size="mini"  >{{$t('el.popconfirm.cancelButtonText')}}</el-button>
    ...
    <el-dialog :visible.sync="fieldOptionModelVisible" :title="optionModelTitle" width="600px" append-to-body destroy-on-close>
      <el-form :show-message="false"	 	 size='mini' :model="fieldOptionForm"  label-width="96px" @submit.native.prevent>
      ...
      <template slot="footer">
        <el-button size="mini"   @click="fieldOptionModelVisible = false">{{$t('el.popconfirm.cancelButtonText')}}</el-button>
        <el-button size="mini"   type="primary" @click="saveFieldOption">{{$t('el.popconfirm.confirmButtonText')}}</el-button>
      </template>
    </el-dialog>
  </div>
</template>
