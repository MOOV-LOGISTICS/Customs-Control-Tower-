...
function formBtns(h) {
  return <el-col>
    <el-form-item >
      <el-button size="mini"  type="primary" onClick={this.submitForm}>提交</el-button>
      <el-button size="mini"  onClick={this.resetForm}>重置</el-button>
    </el-form-item>
  </el-col>
}
...
function renderFormItem(h, elementList) {
  ...
  return elementList.map(scheme => {
    ...
    // edit byDean.Tan，解决 el-upload 上传的问题
