<template>
  <div class="app-container" style="width:90%;margin:0 auto;">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button size="mini"  type="primary" icon="el-icon-plus"  @click="handleExportHtml">导出 HTML</el-button>
        <el-button size="mini"  type="primary" icon="el-icon-plus"  @click="handleExportWord">导出 Word</el-button>
        <el-button size="mini"  type="primary" icon="el-icon-plus"  @click="handleExportMarkdown">导出 Markdown</el-button>
      </el-col>
    </el-row>
