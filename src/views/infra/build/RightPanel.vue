  ...
  <div class="right-board">
    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        <!-- 组件属性 -->
        <el-form :show-message="false"	 	 size='mini' v-show="currentTab==='field' && showField"  label-width="90px">
          ...
          <el-form-item v-if="activeData['prefix-icon']!==undefined" label="前图标">
            <el-input v-model="activeData['prefix-icon']" placeholder="请输入前图标名称">
              <el-button size="mini"  slot="append" icon="el-icon-thumb" @click="openIconsDialog('prefix-icon')">
                选择
              </el-button>
            </el-input>
          </el-form-item>
          <el-form-item v-if="activeData['suffix-icon'] !== undefined" label="后图标">
            <el-input v-model="activeData['suffix-icon']" placeholder="请输入后图标名称">
              <el-button size="mini"  slot="append" icon="el-icon-thumb" @click="openIconsDialog('suffix-icon')">
                选择
              </el-button>
            </el-input>
          </el-form-item>
          ...
          >
            <el-input v-model="activeData['icon']" placeholder="请输入按钮图标名称">
              <el-button size="mini"  slot="append" icon="el-icon-thumb" @click="openIconsDialog('icon')">
                选择
              </el-button>
            </el-input>
          </el-form-item>
          ...
          <template v-if="Array.isArray(activeData.__config__.regList)">
            ...
            <div style="margin-left: 20px">
              <el-button size="mini"  icon="el-icon-circle-plus-outline" type="text" @click="addReg">
                添加规则
              </el-button>
            </div>
          </template>
        ...
        <!-- 表单属性 -->
        <el-form :show-message="false"	 	 size='mini' v-show="currentTab === 'form'"  label-width="90px">
