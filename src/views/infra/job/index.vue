<template>
  <div class="app-container">
    ...
    <!-- 搜索栏 -->
    <el-form v-if="false" :show-message="false"	 	 size='mini' :model="queryParams" ref="queryForm"  :inline="true" v-show="showSearch" label-width="100px">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button size="mini"  type="primary" plain icon="el-icon-plus"  @click="handleAdd"
                   v-hasPermi="['infra:job:create']">{{ $t('search.addNew') }}</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button size="mini"  type="warning" icon="el-icon-download"  @click="handleExport" :loading="exportLoading"
                   v-hasPermi="['infra:job:export']">{{$t('search.export')}}</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button size="mini"  type="info" icon="el-icon-s-operation"  @click="handleJobLog"
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template v-slot="scope">
          <el-button size="mini"   type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
                     v-hasPermi="['infra:job:update']">{{ $t('search.modify') }}</el-button>
          ...
          <el-button size="mini"   type="text" icon="el-icon-delete" @click="handleDelete(scope.row)"
                     v-hasPermi="['infra:job:delete']">{{ $t('search.delete') }}</el-button>
        ...
        <el-form-item label="CRON 表达式" prop="cronExpression">
          <el-input v-model="form.cronExpression" placeholder="请输入CRON 表达式">
            <template slot="append">
              <el-button size="mini"  type="primary" @click="handleShowCron">
                生成表达式
    ...
    <el-dialog title="任务详细" :visible.sync="openView" width="700px" append-to-body>
      <el-form :show-message="false"	 	 size='mini' ref="form" :model="form" label-width="200px" >
        <el-row :gutter="30">
          <el-col :span="24">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button size="mini"  @click="openView = false">关 闭</el-button>
      </div>
    </el-dialog>
  </div>
</template>
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$modal.confirm("是否确认导出所有定时任务数据项?").then(() => {
          ...
          this.$download.excel(response, '定时任务.xlsx');
