<template>
  <div class="app-container" style="width:90%;margin:0 auto;">
    <el-form :show-message="false"	 	 size='mini' label-width="120px">
      <el-row type="flex" :gutter="0">
        ...
        <el-col :offset="1">
          <el-form-item label="" label-width="0px" >
            <el-button size="mini"  @click="connect" type="primary" :disabled="ws&&ws.readyState===1">
              {{ ws && ws.readyState === 1 ? "已连接" : "连接" }}
            </el-button>
            <el-button size="mini"  @click="exit" type="danger">断开</el-button>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-form-item label="" >
        <el-button size="mini"  type="success" @click="send">发送消息</el-button>
      </el-form-item>
      <el-form-item label="接收内容" >
        <el-input type="textarea" v-model="content" :rows="12" disabled/>
      </el-form-item>
      <el-form-item label="" >
        <el-button size="mini"  type="info" @click="content=''">清空消息</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
