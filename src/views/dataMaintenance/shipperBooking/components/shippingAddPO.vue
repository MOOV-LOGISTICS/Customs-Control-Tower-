<template>
  <el-dialog title="Add PO" width="60%" :visible="visible" @close="onHandleClose">
    <el-row :gutter="12">
      <el-col :span="6">
        <el-input v-model="queryParams.orderNumber" placeholder="Order Number" />
      </el-col>
      <el-col :span="6">
...
<script>
import {addPO, getOrderHeaderPage} from "@/api/dataMaintenance/dataMaintenance";
...
export default {
  ...
  methods: {
    async getPage() {
      // 获取shippingId列表
      const res = await getOrderHeaderPage({
