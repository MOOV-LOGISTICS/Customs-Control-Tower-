    ...
    <div class="content">
      ...
      <div class="field">
        ...
        <div class="form-cont">
          ...
          <div>
            <el-form :show-message="false"	 	 size='mini' ref="loginForm" :model="loginForm" class="login-form">
              <!-- 授权范围的选择 -->
              此第三方应用请求获得以下权限：
              ...
              <el-form-item style="width:100%;">
                <el-button size="mini"  :loading="loading"  type="primary" style="width:60%;"
                           @click.native.prevent="handleAuthorize(true)">
                  <span v-if="!loading">同意授权</span>
                  <span v-else>授 权 中...</span>
                </el-button>
                <el-button size="mini"   style="width:36%"
