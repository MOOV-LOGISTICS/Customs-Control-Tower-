    ...
    <div class="content">
      ...
      <div class="field">
        ...
        <div class="form-cont">
          ...
          <div>
            <el-form :show-message="false"	 	 size='mini' ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
              <!-- 账号密码登录 -->
              ...
              <el-form-item style="width:100%;">
                <el-button size="mini"  :loading="loading"  type="primary" style="width:100%;"
