<template>
    <div>
       <el-empty v-if="shipLogList.length==0" description="No Data"></el-empty>
        <el-card style="padding:11px">
          <el-timeline style="margin-top: 30px">
                  <el-timeline-item v-for="(o, index) in shipLogList" :key="index" :timestamp=parseUTCTime(o.createTime)>
                        {{ o.logInfo }}
                      </el-timeline-item>
          </el-timeline>
        </el-card>
