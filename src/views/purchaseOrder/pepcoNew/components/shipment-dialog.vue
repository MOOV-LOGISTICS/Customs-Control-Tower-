<template>
  <el-dialog width="80%" title="Add/Remove" :visible.sync="addRemovePOVisible">
    <div>
...
import { getShippingOrderItemList, getShipmentPage, getShippingOrderPage } from '@/api/pepco/shipping-order'
export default {
  ...
  methods: {
    ...
    async getShippingOrder(shippingId) {
      ...
      await getShippingOrderPage(this.queryParams1).then(response => {
    ...
    getAllShipment() {
      ...
      getShippingOrderPage(this.queryParams).then(response => {
