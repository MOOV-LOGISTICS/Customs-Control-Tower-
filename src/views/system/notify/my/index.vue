<template>
  <div class="app-container" style="width:100%;margin:0 auto;">
    ...
    <el-table v-loading="loading" ref="tables" :data="list">
      ...
      <el-table-column label="Title" align="center" prop="templateNickname" max-heignt="120">
          <template v-slot="scope">
          <div v-html="scope.row.templateNickname" style='height: 20px;'  @click="handleUpdateSingle(scope.row)"></div>
        </template>
      </el-table-column>
    ...
    <el-dialog v-model="clickItem" title="Notification" :visible.sync="messageShow" width="1200px" append-to-body>
      ...
      <H2 style="padding: 0; margin: 0;font-weight: 700;"v-html="clickItem.templateNickname"></H2>
