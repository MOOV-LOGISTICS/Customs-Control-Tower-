  ...
  <div class="container">
    ...
    <el-tabs v-model="activeName" class="tabs">
      ...
      <el-tab-pane label="基础设置" name="basic">
        <el-form :show-message="false"	 	 size='mini' ref="basic" :model="baseForm" :rules="rules" label-width="100px" style="width: 95%">
      ...
      <el-tab-pane label="价格库存" name="rates" class="rates">
        <el-form :show-message="false"	 	 size='mini' ref="rates" :model="ratesForm" :rules="rules">
          ...
          <div v-show="ratesForm.spec === 2">
            <div v-for="(specs, index) in dynamicSpec" :key="index" class="dynamic-spec">
              <!-- 删除按钮 -->
              <el-button size="mini"  type="danger" icon="el-icon-delete" circle class="spec-delete" @click="removeSpec(index)"/>
            ...
            <el-button size="mini"  type="primary" @click="dynamicSpec.push({specValue: []}); ratesForm.rates = []">添加规格项目</el-button>
          </div>
            ...
            <el-table :data="ratesForm.rates" border style="width: 100%" ref="ratesTable">
              ...
              <template v-if="this.specSwitch">
                <el-table-column fixed="right" label="操作" width="50" key="100">
                  <template v-slot="scope">
                    <el-button size="mini"  @click="scope.row.status = 1" type="text"
                               v-show="scope.row.status === undefined || scope.row.status === 0 ">禁用
                    </el-button>
                    <el-button size="mini"  @click="scope.row.status = 0" type="text"  v-show="scope.row.status === 1">
                      启用
                    </el-button>
                  </template>
                </el-table-column>
      ...
      <el-tab-pane label="商品详情" name="detail">
        <el-form :show-message="false"	 	 size='mini' ref="detail" :model="baseForm" :rules="rules">
      ...
      <el-tab-pane label="高级设置" name="senior">
        <el-form :show-message="false"	 	 size='mini' ref="senior" :model="baseForm" :rules="rules" label-width="100px" style="width: 95%">
    ...
    <div class="buttons">
      ...
      <el-button size="mini"  type="success" round @click="submit">确认</el-button>
    </div>
