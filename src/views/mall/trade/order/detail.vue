  ...
  <div class="app-container order-detail-page">
    ...
    <el-descriptions title="订单状态" :column="1">
      ...
      <el-descriptions-item label-class-name="no-colon">
        <el-button size="mini"  type="primary" >调整价格</el-button>  <!-- TODO 芋艿：待实现 -->
        <el-button size="mini"  type="primary" >备注</el-button> <!-- TODO 芋艿：待实现 -->
        <el-button size="mini"  type="primary" >发货</el-button> <!-- TODO 芋艿：待实现 -->
        <el-button size="mini"  type="primary" >关闭订单</el-button>  <!-- TODO 芋艿：待实现 -->
        <el-button size="mini"  type="primary" >修改地址</el-button>  <!-- TODO 芋艿：待实现 -->
        <el-button size="mini"  type="primary" >打印电子面单</el-button>  <!-- TODO 芋艿：待实现 -->
        <el-button size="mini"  type="primary" >打印发货单</el-button>  <!-- TODO 芋艿：待实现 -->
        <el-button size="mini"  type="primary" >确认收货</el-button>  <!-- TODO 芋艿：待实现 -->
      </el-descriptions-item>
