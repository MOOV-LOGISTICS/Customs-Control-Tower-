      ...
      <el-form :show-message="false"	 	 size='mini' :model="queryParams" ref="queryForm"  :inline="true" v-show="showSearch" label-width="120px">
        ...
        <el-col :span="6" :xs="24">
          <el-form-item label="订单来源" prop="terminal">
            <el-select v-model="queryParams.terminal" clearable >
        ...
        <el-col :span="6" :xs="24">
          <el-form-item label="支付方式" prop="payChannelCode">
            <el-select v-model="queryParams.payChannelCode" clearable >
              ...
              <el-row type="flex" align="middle">
                <el-col :span="5">
                  ...
                  <el-popover title="支付单号：" :content="row.payOrderId + ''" placement="right" width="200" trigger="click">
                    <el-button size="mini"  slot="reference" type="text">更多</el-button>
                  </el-popover>
                </el-col>
                ...
                <el-col :span="6" align="right">
                  <el-button size="mini"  type="text" @click="goToDetail(row)">详情</el-button>
                </el-col>
              </el-row>
              <!-- 订单下的商品 -->
