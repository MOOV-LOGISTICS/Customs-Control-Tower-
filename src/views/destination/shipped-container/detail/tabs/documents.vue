<template>
  <div style="margin-top: -25px;">
    <!-- <h3>Document 表单</h3> -->
    <el-table :data="documentList" height="250" style="width: 100%;" v-loading="loading">
      <el-table-column prop="documentNumber" label="Document Number" align="center" min-width="120"></el-table-column>
      <el-table-column prop="shippingOrderNumber" label="Shipper Booking Ref" align="center" min-width="120"></el-table-column>
      <el-table-column prop="typeCode" label="Document Type" align="center" min-width="150" sortable>
        <template #default="scope">{{ getDocumentTypeLabel(scope.row.typeCode) }}</template>
      </el-table-column>
      <el-table-column prop="blType" label="BL Type" min-width="200" align="center">
        <template slot-scope="scope">
          <span>{{ ['03', '04'].includes(scope.row.typeCode) ? scope.row.blType : '/' }}</span>
        </template>
      </el-table-column>
      <el-table-column prop="fileName" label="File Name" align="center" show-overflow-tooltip min-width="150"></el-table-column>
      <el-table-column label="Action" min-width="200" align="center">
