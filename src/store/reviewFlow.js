...
export const reviewStore = Vue.observable({
  hbls: [
    ...
    mkHbl('MOOV240002', 'MAEU240002', 'Dhaka Garments Ltd.', 'BGCGP', 'DEHAM', '2024-12-15',
      ...
      [
        doc('Commercial Invoice', 'INV-240002.pdf', 1, 'PO-2401-2001', '2024-11-10 11:02'),
        doc('Packing List',       'PL-240002.pdf',  1, 'PO-2401-2001', '2024-11-10 11:05'),
        doc('Bill of Lading',     'HBL-240002.pdf', 1, 'PO-2401-2001', '2024-11-11 09:40'),
      ],
      [
    ...
    mkHbl('MOOV240004', 'HLCU240004', 'Istanbul Fashion AS', 'TRIST', 'ROBUH', '2024-12-10',
      ...
      ms('IN_PROGRESS'),
      [
        doc('Commercial Invoice',    'INV-240004.pdf', 1, 'PO-2401-4001', '2024-11-09 10:11'),
        doc('Packing List',          'PL-240004.pdf',  1, 'PO-2401-4001', '2024-11-09 10:14'),
        doc('Sanitary Certificate',  'SAN-240004.pdf', 1, 'PO-2401-4002', '2024-11-10 13:00'),
      ],
      [
        { milestone: 'PGS Check',     status: 'Complete', user: 'Sarah J. (PGS)',   time: '2024-11-13 10:30 CET (UTC+1)', reason: '', remark: '', isRecheck: false },
    ...
    mkHbl('MOOV240005', 'MAEU240005', 'Mumbai Textiles Pvt', 'INNSA', 'HUBU', '2024-11-28',
      ...
      [
        doc('Commercial Invoice', 'INV-240005.pdf', 1, 'PO-2401-5001', '2024-11-05 08:30'),
        doc('Packing List',       'PL-240005.pdf',  1, 'PO-2401-5001', '2024-11-05 08:32'),
        doc('Bill of Lading',     'HBL-240005.pdf', 1, 'PO-2401-5001', '2024-11-06 10:00'),
      ],
      [
    ...
    mkHbl('MOOV240006', 'EGLV240006', 'Guangzhou Clothing Co.', 'CNGZU', 'PLWAW', '2024-12-18',
      ...
      ms('PENDING_CORRECTION', null, null, false, 'Waiting for Supplier correction'),
      [
        doc('Commercial Invoice',   'INV-240006.pdf', 1, 'PO-2401-6001', '2024-11-12 09:00'),
        doc('Packing List',         'PL-240006.pdf',  1, 'PO-2401-6001', '2024-11-12 09:03'),
