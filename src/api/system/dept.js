...
export function importTemplate() {
  return request({
    url: '/system/dept/get-import-template',
    method: 'get',
    responseType: 'blob'
  })
}
...
export function getDeptList(query) {
  return request({
    url: '/system/dept/listByIds',
    method: 'get',
    params: query
  })
}

export function getDeptAll(partyRole) {
  return request({
    url: '/system/dept/all',
    method: 'get',
    params: { partyRole }
...
// 获取部门详细信息列表
export function listDetailDepts() {
  return request({
    url: '/system/dept/list-all-detail',
    method: 'get'
  })
}
